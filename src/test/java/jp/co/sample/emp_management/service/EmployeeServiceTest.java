...
class EmployeeServiceTest {
	...
	public void testInsert() {
		...
		employeeService.register(employee3);
	...
	public void loadTest2() {
		...
		Employee employee = employeeService.showDetail(2);
	...
	public void loadTest3() {
		...
		Employee employee = employeeService.showDetail(3);
	...
	public void updateTest() {
		...
		employee = employeeService.showDetail(1);
	...
	public void findByKeyNameTest() {
		...
		List<Employee> searchEmployeeList = employeeService.search("郎");
	...
	public void findByMailAddressTest1() {
		...
		assertTrue(employeeService.findByMailAddress("watanabe@sample.com"), "メールアドレスが存在していません。");
	...
	public void findByMailAddressTest2() {
		...
		assertFalse(employeeService.findByMailAddress("aioeo@sample.com"), "メールアドレスが存在しています。");
